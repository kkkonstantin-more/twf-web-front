...
!(function () {
  ...
  (l.prototype = $t.p),
    ...
    (Et.em = Et.italic = Et.italics = Et.emph = Et.textit = Et.textsl = h(
      "\\textit",
      "i",
      'class="mq-text-mode"'
    )),
    (Et.strong = Et.bold = Et.textbf = h(
      "\\textbf",
      "b",
      'class="mq-text-mode"'
    )),
    ...
    (Et.notin = Et.cong = Et.equiv = Et.oplus = Et.otimes = Qt(Q, function (
      t,
      e
    ) {
      t.init = function (t) {
    ...
    (Et.notni = Et.niton = Et.notcontains = Et.doesnotcontain = i(
      Q,
      "\\not\\ni ",
      "&#8716;"
    )),
    ...
    (Et.nsub = Et.notsub = Et.nsubset = Et.notsubset = i(
      Q,
      "\\not\\subset ",
      "&#8836;"
    )),
    ...
    (Et.sube = Et.subeq = Et.subsete = Et.subseteq = i(
      Q,
      "\\subseteq ",
      "&sube;"
    )),
    (Et.supe = Et.supeq = Et.supsete = Et.supseteq = Et.supersete = Et.superseteq = i(
      Q,
      "\\supseteq ",
      "&supe;"
    )),
    ...
    (Et.H = Et.Hamiltonian = Et.quaternions = Et.Quaternions = i(
      j,
      "\\mathbb{H}",
      "&#8461;"
    )),
    ...
    (Et["…"] = Et.dots = Et.ellip = Et.hellip = Et.ellipsis = Et.hellipsis = i(
      j,
      "\\dots ",
      "&hellip;"
    )),
    (Et.converges = Et.darr = Et.dnarr = Et.dnarrow = Et.downarrow = i(
      j,
      "\\downarrow ",
      "&darr;"
    )),
    (Et.dArr = Et.dnArr = Et.dnArrow = Et.Downarrow = i(
      j,
      "\\Downarrow ",
      "&dArr;"
    )),
    ...
    (Et.lArr = Et.Leftarrow = i(j, "\\Leftarrow ", "&lArr;")),
    (Et.harr = Et.lrarr = Et.leftrightarrow = i(
      j,
      "\\leftrightarrow ",
      "&harr;"
    )),
    ...
    (Et.Im = Et.imag = Et.image = Et.imagin = Et.imaginary = Et.Imaginary = i(
      j,
      "\\Im ",
      "&image;"
    )),
    ...
    (Et.alef = Et.alefsym = Et.aleph = Et.alephsym = i(
      j,
      "\\aleph ",
      "&alefsym;"
    )),
    ...
    (function () {
      ...
      for (
        ...
        z[n[t]] = z["arc" + n[t]] = z[n[t] + "h"] = z["ar" + n[t] + "h"] = z[
          "arc" + n[t] + "h"
        ] = 1;
  ...
  (Et.operatorname = Qt(O, function (e) {
    ...
    (Et.Upsilon = Et.Upsi = Et.upsih = Et.Upsih = i(
      k,
      "\\Upsilon ",
    ...
    (Et["÷"] = Et.div = Et.divide = Et.divides = i(
      Q,
      "\\div ",
      "&divide;",
      "[/]"
