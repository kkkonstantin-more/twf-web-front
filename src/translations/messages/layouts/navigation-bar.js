...
const navigationBarRu = {
  [prefix + ".link.forPlayers"]: "Игрокам",
  [prefix + ".link.forTutors"]: "Преподавателям",
...
const navigationBarEn = {
  [prefix + ".link.forPlayers"]: "For players",
  [prefix + ".link.forTutors"]: "For tutors",
