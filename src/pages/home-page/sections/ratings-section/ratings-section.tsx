...
import {FetchedUsersData, UsersSortingProperty} from "../../../../redux/user-tabs/user-tabs.types";
...
const RatingsSection: React.FC = () => {
    ...
    useEffect(() => {
        axios({
            ...
            data: {offset: 0, limit: 100, sortedBy: UsersSortingProperty.BY_RATING, descending: true}
        }).then((res) => {
            ...
            const filterData: UserData[] = res.data
                .filter((item: FetchedUsersData) => {
                    ...
                    return !(item.additionalInfo.includes("SPBPU") ||
