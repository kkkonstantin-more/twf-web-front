...
const UserRatingTab: React.FC<UserRatingTabProps> = ({
    ...
    const iconPath: string = [1, 2, 3].indexOf(place) === -1 ? mdiStar : mdiTrophy;

    return (
        <div className={`user-rating-tab ${currentUser ? "user-rating-tab--current-user" : ''}`}>
            <div className="user-rating-tab__place">
                #{ place }
            </div>
            <div
            ...
            />
            <div className="user-rating-tab__name">
                { name }
            </div>
