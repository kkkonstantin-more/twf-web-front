...
import LevelForm, { LevelFormProps, LevelType } from "./level-form";
...
const CustomForms: React.FC = () => {
  type FormInputs = {
    ...
    levels: {
      ...
      levelNameRu: string;
      levelCode: string;
      countOfAutoGeneratedLevels: number;
      operations: string;
      stepsCountIntervals: string;
      implicitTransformationCount: number;
    }[];
  };
  ...
  const [levelType, setLevelType] = useState<string>("ручное");
  const [allLevels, setAllLevels] = useState<any[]>(fields);
